...
object InternalExecutionModel {
   ...
   internal fun snapshotTestUuidMap(): Map<Descriptor, String> = HashMap(testUuidMap)
   ...
   internal fun restoreTestUuidMap(snapshot: Map<Descriptor, String>) {
      testUuidMap.clear()
      testUuidMap.putAll(snapshot)
      iterationMap.clear()
   }
